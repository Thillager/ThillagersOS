...
public class SystemMonitorApp extends JInternalFrame {
    ...
    private GraphPanel cpuGraph = new GraphPanel(); // Unser neuer Graph
    private OperatingSystemMXBean osBean;
    private JLabel ramLabel = new JLabel("RAM: 0%");
    private JLabel ramProcessLabel = new JLabel("RAM (Prozess): 0%");

    public SystemMonitorApp() {
        super("System Monitor2", true, true, true, true);
    ...
    private void updateStats() {
        try {
            // RAM berechnen (wie du es schon hattest)
            ...
            ramProcessLabel.setText("RAM (Prozess): " + ProcesRam + "%");
