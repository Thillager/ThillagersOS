    ...
    term.getInputField().postActionEvent();
                ...
                switch (mode.toLowerCase()) {
                    case "java":
                        ...
                        if (javaFile.exists()) {
                            ...
                            if (jarFile.exists()) runJarGui(jarFile, mainClass);
                        }
                        break;
                    ...
                    case "terminal":
                        ...
                        if (jarFile.exists()) runJarInTerminal(jarFile, mainClass);
                        else {
        ...
        switch (title.toLowerCase()) {
            ...
            default:
                ...
                else if(title.endsWith(".java")) path = "/resources/jar.png";
                else if(title.endsWith(".illag")) path = "/resources/illag.png";
